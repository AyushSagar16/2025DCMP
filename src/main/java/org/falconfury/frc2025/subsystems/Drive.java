...
public class Drive extends SubsystemBase {
  ...
  public Drive() {
    // Initialize Gyro
    gyro_ = new Pigeon2(0, "rio");
    gyro_.getConfigurator().apply(new Pigeon2Configuration());
  ...
  public void periodic() {
    // Read inputs
    io_.angle = -Math.toRadians(gyro_.getYaw().getValueAsDouble());
